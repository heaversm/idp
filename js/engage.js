...
//https://codepen.io/heaversm/pen/YzPOPLJ
...
function initialize(){
    ...
    var metaballsGroup1 = {
        ...
        texture:generateGradientTexture([{color:c1, stop:0.2}, {color:c2, stop:.35}, {color:c3, stop:.55}, {color:c1, stop:.75}, {color:c3, stop:1.0}], false, false)
    };
    var metaballsGroup2 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:c1, stop:0.0}, {color:c1, stop:0.3}, {color:c2, stop:.4}, {color:c3, stop:.7}], true, false)
    };
    var metaballsGroup3 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:c1, stop:0.56}, {color:c2, stop:.63}, {color:c3, stop:.7}], false, false)
    };
    var metaballsGroup4 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:c1, stop:0.1}, {color:c2, stop:.20}, {color:c3, stop:.4}], false, false)
    };
    var metaballsGroup5 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:c1, stop:0.25}, {color:c2, stop:.60}, {color:c3, stop:0.78}], true, false)
    };
    var metaballsGroup6 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:c1, stop:0.0}, {color:c1, stop:0.7}, {color:c2, stop:.8}, {color:c3, stop:1.0}], false, false)
    };
    var metaballsGroup7 = {
        metaballs:[
        ...
        texture:generateGradientTexture([{color:c1, stop:0.2}, {color:c2, stop:.4}, {color:c3, stop:.7}], true, false)
    };
...
function generateGradientTexture(colors, vertical, debug) {
    ...
    colors = colors || [{color:'#000000', stop:0.0}, {color:'#FFF000', stop:.5}, {color:c4, stop:1.0}];
